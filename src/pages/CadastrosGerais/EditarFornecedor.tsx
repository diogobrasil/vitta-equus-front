...
export default function EditarFornecedor() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("📤 Editar Fornecedor:", JSON.stringify(form, null, 2));
        alert("Fornecedor atualizado! (verifique o console)");
    };

    const handleDelete = () => {
        if(window.confirm("Deseja realmente excluir/inativar este fornecedor?")) {
            console.log("🗑️ Fornecedor excluído:", id);
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">
                    Edite os dados do fornecedor parceiro do haras.
                </p>
            </div>
