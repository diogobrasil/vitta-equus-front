        ...
        <div className="rounded-xl border border-neutral-200 bg-white shadow-sm">
            ...
            <div className="flex flex-col gap-3 border-b border-neutral-100 p-6 sm:flex-row sm:items-center sm:gap-4">
                ...
                <select
                    ...
                    className="rounded-lg border border-neutral-200 bg-neutral-50 px-4 py-2 text-sm text-neutral-700 outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
                >
                    <option>Todos</option>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center justify-end gap-1">
                                        <button
                                            ...
                                            title="Ver Perfil"
                                            className="rounded-lg p-2 text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-teal-600"
                                        >
