...
export default function NovoProprietario() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("📤 Novo Proprietário:", JSON.stringify(form, null, 2));
        alert("Proprietário cadastrado! (verifique o console)");
    };
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">
                    Registre os dados do proprietário ou responsável legal.
                </p>
            </div>
